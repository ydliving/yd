    ...
    public static function gravityforms_settings_page(){
              ...
              <tr valign="top">
                   <th scope="row"><label for="gforms_key"><?php _e("Support License Key", "gravityforms"); ?></label>  <?php gform_tooltip("settings_license_key") ?></th>
                    <td>
                        ...
                        $key_field = '<input type="password" disabled name="gforms_key" id="gforms_key" style="width:350px;" value="' . $key . '" />';
                        ...
                        ?>
                        <br />
                        <?php _e("It is tea time dude.", "gravityforms"); ?>
                    </td>
                </tr>
               <tr valign="top">
                ...
                <tr valign="top">
                    ...
                    <td>
                        ...
                        <select id="gforms_currency" name="gforms_currency" disabled>
                            <?php
        ...
        <form action="" method="post">
            <?php if(GFCommon::current_user_can_any("gravityforms_uninstall") && (!function_exists("is_multisite") || !is_multisite() || is_super_admin())){ ?>
                ...
                <div class="delete-alert alert_red"><h3><?php _e("Warning", "gravityforms") ?></h3><p><?php _e("", "gravityforms") ?></p>
                    <?php
                    $uninstall_button = '<input disabled type="submit" name="uninstall" value="' . __("Uninstall Gravity Forms", "gravityforms") . '" class="button" onclick="return confirm(\'' . __("Warning! ALL Gravity Forms data, including form entries will be deleted. This cannot be undone. \'OK\' to delete, \'Cancel\' to stop", "gravityforms") . '\');"/>';
