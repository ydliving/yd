...
// 	{
// 		$new_begin_at = get_post_meta( $post_id, 'begin_at', true );
// 		$new_end_at = get_post_meta( $post_id, 'apply_end_at', true );

// 		echo $new_end_at;

// 		update_post_meta( $post_id, 'begin_at', substr($new_begin_at, 0, -3));
// 	  update_post_meta( $post_id, 'apply_end_at', substr($new_end_at, 0, -3));

// 	 //  $new_end_at = get_post_meta( $post_id, 'apply_end_at', true );
// 	 //  echo '<br />';
// 	 //  echo substr($new_end_at, 0, -3);
// 		// exit();

// 	}
// }
// add_action( 'save_post', 'hack_time' );


function t_format($timestmap)
{
	// echo gmdate("Y-m-d", substr($timestmap, 0, -3));
	echo gmdate("Y-m-d", $timestmap);
}
...
function yd_scripts ()
{
	...
	// wp_register_script( 'jquery', get_template_directory_uri() . '/js/jquery-1.7.2.min.js', true , null);
