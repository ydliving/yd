...
<?php if ($comments) : ?>
	<div class="newInfor cl">
		<div id="comments">
			<div class="hB">
				<?php the_title(); ?>：已吐槽 <?php comments_number('', '1 次', '% 次' );?></div>
			</div>
			<div class="pcon cl">
				<ol class="commentlist">
					<?php wp_list_comments('type=comment&callback=h_comment&end-callback=h_end_comment&max_depth=23'); ?>
				</ol>
									...
									<form action="<?php echo get_option('siteurl'); ?>/wp-comments-post.php" method="post" id="commentform">
										<?php if ( $user_ID ) : ?>
											...
											<?php elseif ( '' != $comment_author ): ?>
												<div class="author">欢迎回来，<?php echo $comment_author; ?>
	...
	<div class="clear"></div>
	<p>
		<?php if (get_option('h_smiley') == 'Display') include(TEMPLATEPATH . '/includes/smiley.php');?>
	</p>
